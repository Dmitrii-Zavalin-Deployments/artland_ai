...
def test_main_schema_validation_failure(setup_pipeline_environment, tmp_path, monkeypatch):
    ...
    input_file.write_text(json.dumps({"input_zip_path": "dummy.zip", "processed_photos_zip_path": "processed.zip", "magazine_assets_zip_path": "magazine.zip", "invalid_field": 123}), encoding="utf-8")
